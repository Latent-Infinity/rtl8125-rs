...
ROWS=(
  ...
  "PRESENT|get_wol|.get_wol|$ETH_C"
  "PRESENT|set_wol|.set_wol|$ETH_C"
  # ---- PLANNED: mainline r8169 compatibility / production parity gaps. ----
  "DEFER|set_ringparam|bridge_set_ringparam|$ETH_C"
  "PRESENT|ndo_features_check|.ndo_features_check|$NETDEV_C"
  "PRESENT|ndo_eth_ioctl|.ndo_eth_ioctl|$NETDEV_C"
  "PRESENT|get_ts_info|.get_ts_info|$ETH_C"
  "PRESENT|get_eth_mac_stats|.get_eth_mac_stats|$ETH_C"
  "PRESENT|get_eth_ctrl_stats|.get_eth_ctrl_stats|$ETH_C"
  "PRESENT|get_pause_stats|.get_pause_stats|$ETH_C"
  "PRESENT|get_eee|.get_eee|$ETH_C"
  "PRESENT|set_eee|.set_eee|$ETH_C"
  "DEFER|get_rxnfc|.get_rxnfc|$ETH_C"
  "DEFER|set_rxnfc|.set_rxnfc|$ETH_C"
  "PRESENT|get_regs|.get_regs|$ETH_C"
  "DEFER|get_eeprom|.get_eeprom|$ETH_C"
  "PRESENT|get_msglevel|.get_msglevel|$ETH_C"
  "PRESENT|set_msglevel|.set_msglevel|$ETH_C"
  "DEFER|netpoll|.ndo_poll_controller|$NETDEV_C"
  "PRESENT|wol_broader_modes|WAKE_UCAST|$ETH_C"
