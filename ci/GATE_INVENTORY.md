...
| `check_clean_contract_docs.sh` | Source comments don't reference stale development stages / removed IRQ modes / etc. |
...
| Gate | What it enforces |
|---|---|
| `check_counter_infrastructure.sh` | disposition-counter set is allocated, exported via ethtool -S, summed across CPUs |
