...
|---|---|---|---|
| 1 | MSI-X (replace legacy IRQ) | **scoped** | `docs/MSIX_DESIGN.md` |
...
| 3 | Jumbo frames (MTU 9000) | **scoped** | `docs/JUMBO_DESIGN.md` |
...
`docs/MULTIQUEUE_RSS.md` (superseded notice) and
...
_Original (incorrect) rationale, kept for history:_ `docs/MULTIQUEUE_RSS.md`
