...
"freebsd-src|https://github.com/freebsd/freebsd-src.git|HEAD|main|sys/dev/re sys/dev/mii share/man/man4/re.4|FreeBSD re(4) driver, fetched 2026-05-26 — VERIFIED ABSENT for 8125: re(4) chip table stops at 8168H/8411B, no 8125 support upstream. Keeping the reference entry as a 'we checked, no' record. Use freebsd-realtek-re-kmod instead for actual 8125 reference."
"freebsd-realtek-re-kmod|https://github.com/alexdupre/rtl_bsd_drv.git|bff7ba434755ec008f58312ff71c3b08a230aabe|v1.101||Realtek's official BSD driver, packaged by alexdupre for FreeBSD ports as net/realtek-re-kmod (port at HEAD ref v1.101). Supports RTL8125/8125B/8126. BSD-4-clause licensed; read-only per §9.3. The repo also has a 'vendor' branch (unmodified Realtek BSD source) — compare against master to see what stability patches the port maintainer added. Useful as a 4th independent implementation viewpoint."
)
